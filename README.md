...
| ----------------------- | ----------------------------- | ----------------------------------------------------------------------------------- | --------- |
| jsvc_src_version        | `1.5.1`                       | Apache Commons' Daemon latest release                                               | No        |
...
- hosts: servers
  become: true
  vars:
    jsvc_tar_src: commons-daemon-1.5.1-native-src.tar.gz
    jsvc_tar_src_remote: false
...
[RHEL: OpenJDK Life Cycle and Support Policy]: https://access.redhat.com/articles/1.5.113
